...
#ifndef DI_RENDERPOINTS_H
#define DI_RENDERPOINTS_H
...
namespace di
{
    ...
    {
        /**
         * Render point Data. This class implements the algorithm and the visualization.
         */
        class RenderPoints: public di::core::Algorithm,
        ...
        private:
            /**
             * The point input to use.
             */
            SPtr< di::core::Connector< di::core::PointDataSet > > m_pointDataInput;

            /**
             * The point data to visualize. We keep the pointer separate since process() and update()/render() work in different threads.
             */
            ConstSPtr< di::core::PointDataSet > m_visPointData = nullptr;
