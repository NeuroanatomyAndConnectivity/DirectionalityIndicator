    ...
    namespace gui
    {
        ...
        public:
            ...
            */
            ...
            /**
             * Set this to reserve extra space for a margin. This function does not set the margin. This is still your task, using stylesheets.
             * You will not need this when using QLabel::setMargin().
             *
